...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::audit_log::verify_audit_log,
            commands::dunning::run_dunning,
            commands::recurring::create_recurring_invoice,
            commands::recurring::list_recurring_invoices,
            commands::recurring::set_recurring_invoice_active,
            commands::recurring::delete_recurring_invoice,
            commands::recurring::run_recurring_invoices,
